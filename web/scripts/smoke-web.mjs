...
assertExists('docs/case-studies/adding.md');
assertExists('docs/case-studies/editing.md');
assertExists('docs/device-thumbnails/catalog.md');
assertExists('docs/device-thumbnails/customizing.md');
